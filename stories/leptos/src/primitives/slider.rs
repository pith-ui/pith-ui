...
pub fn RightToLeft() -> impl IntoView {
    view! {
        <SliderRoot attr:class=classes::root dir=radix_leptos_primitives::direction::Direction::Rtl>
            <SliderTrack attr:class=classes::track>
                <SliderRange attr:class=classes::range />
            </SliderTrack>
            <SliderThumb attr:class=classes::thumb />
        ...
        <>
            ...
            <div style:display="flex" style:gap="50px">
                ...
                <div style:flex="1">
                    <h3>"RTL"</h3>
                    <h4>"Default"</h4>
                    <SliderRoot attr:class=classes::root default_value=vec![20.0] dir=radix_leptos_primitives::direction::Direction::Rtl>
                        <SliderTrack attr:class=classes::track>
                            <SliderRange attr:class=classes::range />
                        </SliderTrack>
                        <SliderThumb attr:class=classes::thumb />
                    ...
                    <h4>"Inverted"</h4>
                    <SliderRoot attr:class=classes::root default_value=vec![20.0] dir=radix_leptos_primitives::direction::Direction::Rtl inverted=true>
                        <SliderTrack attr:class=classes::track>
                            <SliderRange attr:class=classes::range />
                        </SliderTrack>
                        <SliderThumb attr:class=classes::thumb />
            ...
            <div style:display="flex" style:gap="50px">
                ...
                <div style:flex="1">
                    ...
                    <div style:display="flex" style:gap="50px">
                        <div>
                            <h4>"Default"</h4>
                            <SliderRoot attr:class=classes::root default_value=vec![20.0] dir=radix_leptos_primitives::direction::Direction::Rtl orientation=Orientation::Vertical>
                                <SliderTrack attr:class=classes::track>
                                    <SliderRange attr:class=classes::range />
                                </SliderTrack>
                                <SliderThumb attr:class=classes::thumb />
                        ...
                        <div>
                            <h4>"Inverted"</h4>
                            <SliderRoot attr:class=classes::root default_value=vec![20.0] dir=radix_leptos_primitives::direction::Direction::Rtl orientation=Orientation::Vertical inverted=true>
                                <SliderTrack attr:class=classes::track>
                                    <SliderRange attr:class=classes::range />
                                </SliderTrack>
                                <SliderThumb attr:class=classes::thumb />
...
pub fn Chromatic() -> impl IntoView {
    view! {
        <>
            ...
            <SliderRoot attr:class=classes::root default_value=vec![10.0, 30.0] dir=radix_leptos_primitives::direction::Direction::Rtl>
                <SliderTrack attr:class=classes::track>
                    <SliderRange attr:class=classes::range />
                </SliderTrack>
                <SliderThumb attr:class=classes::thumb />
            ...
            <h1>"Direction"</h1>
            <h2>"Prop"</h2>
            <SliderRoot attr:class=classes::root value=vec![20.0] dir=radix_leptos_primitives::direction::Direction::Rtl>
                <SliderTrack attr:class=classes::track>
                    <SliderRange attr:class=classes::range />
                </SliderTrack>
                <SliderThumb attr:class=classes::thumb />
            </SliderRoot>
            <SliderRoot attr:class=classes::root value=vec![10.0, 30.0] dir=radix_leptos_primitives::direction::Direction::Rtl>
                <SliderTrack attr:class=classes::track>
                    <SliderRange attr:class=classes::range />
                </SliderTrack>
                <SliderThumb attr:class=classes::thumb />
            ...
            <h2>"Inherited"</h2>
            <DirectionProvider direction=radix_leptos_primitives::direction::Direction::Rtl>
                <SliderRoot attr:class=classes::root value=vec![20.0]>
                    <SliderTrack attr:class=classes::track>
                        <SliderRange attr:class=classes::range />
                    </SliderTrack>
