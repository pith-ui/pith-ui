...
import '../../../shared/password-toggle-field.css';

export default function PasswordToggleFieldPage() {
        ...
        <>
            ...
            <div className="ptf-field">
                <PasswordToggleField.Root visible={visible} onVisiblityChange={setVisible}>
                    <PasswordToggleField.Input id="password" className="ptf-input" />
                    <PasswordToggleField.Toggle className="ptf-toggle">
                        <PasswordToggleField.Icon
                            visible={<EyeOpenIcon data-testid="eye-open" />}
                            hidden={<EyeClosedIcon data-testid="eye-closed" />}
                        />
            ...
            <div className="ptf-field">
                <PasswordToggleField.Root>
                    <PasswordToggleField.Input id="pin" className="ptf-input" />
                    <PasswordToggleField.Toggle className="ptf-toggle">
            ...
            >
                ...
                <div className="ptf-field">
                    <PasswordToggleField.Root>
                        <PasswordToggleField.Input id="form-password" className="ptf-input" />
                        <PasswordToggleField.Toggle className="ptf-toggle">
                            <PasswordToggleField.Slot visible="Hide" hidden="Show" />
                        </PasswordToggleField.Toggle>
                    </PasswordToggleField.Root>
