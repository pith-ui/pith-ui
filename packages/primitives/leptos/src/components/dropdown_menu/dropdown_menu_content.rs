...
pub fn DropdownMenuContent(
    ...
    view! {
        <MenuContent
            ...
            as_child=as_child
            node_ref=node_ref
            style:--dropdown-menu-content-transform-origin="var(--popper-transform-origin)"
            style:--dropdown-menu-content-available-width="var(--popper-available-width)"
            style:--dropdown-menu-content-available-height="var(--popper-available-height)"
            style:--dropdown-menu-trigger-width="var(--popper-anchor-width)"
            style:--dropdown-menu-trigger-height="var(--popper-anchor-height)"
