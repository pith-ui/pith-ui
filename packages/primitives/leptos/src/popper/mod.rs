...
use floating_ui_leptos::{
    ...
    Offset, OffsetOptions, OffsetOptionsValues, Placement, Shift, ShiftOptions, Size, SizeOptions,
    Strategy, UseFloatingOptions, UseFloatingReturn, VirtualElement, VirtualElementOrNodeRef,
    use_floating,
};
pub use floating_ui_leptos::{
    ClientRectObject, Padding, Side, VirtualElement as PopperVirtualElement,
};
...
pub fn Popper(
    ...
    let anchor_ref = anchor_ref.unwrap_or_default();
