...
rust_location: "[[packages/primitives/leptos/src/scroll_area/mod.rs|scroll_area]]"
...
- **Thumb positioning**: Pure functions `get_thumb_ratio`, `get_thumb_size` (min 18px), `get_scroll_position_from_pointer`, `get_thumb_offset_from_scroll`, `linear_scale`. Uses `pith_ui_number::clamp`.
