...
rust_location: "[[packages/primitives/leptos/src/toolbar/mod.rs|toolbar]]"
...
- **Orientation type**: The toolbar context stores `pith_ui_roving_focus::Orientation` and converts to `pith_ui_separator::Orientation` for `ToolbarSeparator` since these are separate types in the Leptos implementation.
