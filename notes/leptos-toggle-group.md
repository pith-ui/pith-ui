...
rust_location: "[[packages/primitives/leptos/src/toggle_group/mod.rs|toggle_group]]"
...
- Dependencies: `leptos`, `leptos-node-ref`, `cardo-ui-primitive`, `cardo-ui-roving-focus`, `cardo-ui-direction`, `cardo-ui-use-controllable-state` (note: `cardo-ui-toggle` is NOT a dependency since items render buttons directly).
