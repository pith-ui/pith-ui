            ...
            <section class="space-y-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input
                        ...
                        class="h-9 w-64 rounded-md border border-input bg-transparent px-3 text-sm text-foreground placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 outline-none"
                    />
                </div>
            </section>
        </div>
