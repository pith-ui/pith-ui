...
```shell
cargo add pith-ui-progress
```

-   [View on crates.io](https://crates.io/crates/pith-ui-progress)
-   [View on docs.rs](https://docs.rs/pith-ui-progress/latest/pith_ui_progress/)
-   [View source](https://github.com/pith-ui/pith-ui/tree/main/packages/primitives/leptos/progress)
